...
const CANONICAL = {
  ...
  FacilityAttackFx: "VillageId,Stage,Level,Mode,BallRuid,Ball2Ruid,HitRuid,CastRuid,CountMin,CountMax,IntervalSec,Scale,HitScale,FlightSec,ArcHeight,StickSec,LaunchOffsetY,CastOffsetX,CastOffsetY,FaceDeg,Enabled,SplitHits,HitStartFrame,HitOffsetX,HitOffsetY,#Note",
...
const PK = {
  ...
  VillageFacilityTrait: ["VillageId", "Stage", "TraitKey"],
  FacilityAttackFx: ["VillageId", "Stage", "Level"],
