...
### Play 검증 5차 (대기 · 재입장 + Reimport All 뒤)

| 항목 | 기대 | 결과 |
|---|---|---|
| 빌드 경고 | 1 → 1 | 대기 |
| 시전 | 80003316 주황 광선 · 바라보는 쪽 | 대기 |
| 타격 | 80003316 붉은 X · 시전당 1회(`hitFx=1`) | 대기 |
| 한손 잔상 O1 · O2 · O3 | 파란 잔상 · 빈 0프레임이 안 보인다 · 위치(오른쪽 · 왼쪽) | 대기 |
| 두손 잔상 T1 · T2 · T3 | 붉은 잔상 그대로 | 대기 |
| 잔상 타이밍 | 접촉 프레임에 · 0.35s (4차와 같게) | 대기 |
| 사용자 시각 확인 (연출 · 잔상 타이밍) | — | 대기 |
